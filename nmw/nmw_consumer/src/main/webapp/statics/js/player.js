...
var player=function() {
   ...
   var playerObj = {
       ...
       play: function() {
           ...
           this.playTime();
           $playBt.attr({
               'src'       : '../../statics/imgs/song/pause.png',
               'title'     : '暂停'
           });
       },
       //暂停
       pause: function() {
           ...
           this.clearTime();
           $playBt.attr({
               'src'       : '../../statics/imgs/song/play.png',
               'title'     : '播放'
           });
       },
       /**
       ...
       event: function() {
           ...
           $muteBt.click(function() {
               if (audio.muted) {
                   audio.muted = false;
                   $(this).attr({
                       src   : '../../statics/imgs/song/voice.png',
                       title : '静音'
                   });
               }else {
                   audio.muted = true;
                   $(this).attr({
                       src   : '../../statics/imgs/song/mute.png',
                       title : '恢复音量'
                   });
               }
           });
           ...
           $circuBt.click(function() {
               if (audio.loop) {
                   audio.loop = false;
                   $(this).attr({
                       src  : '../../statics/imgs/song/xunhuan1.png',
                       title : '列表循环'
                   });
               }else{
                   audio.loop = true;
                   $(this).attr({
                       src  : '../../statics/imgs/song/xunhuan2.png',
                       title : '单曲循环'
                   });
               }
           });
