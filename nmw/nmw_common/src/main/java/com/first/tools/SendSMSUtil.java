...
public class SendSMSUtil {
    ...
    // 替换成你的AK
    private static final String accessKeyId = "LTAI4FziwcLVrhrxHWcJbzhk";// 你的accessKeyId
    private static final String accessKeySecret = "eIBw2thgIYVGJZ24TN706pe9O8b5gL";// 你的accessKeySecret
    private static final String signName = "TECH";// 签名
    private static final String templateCode = "SMS_198927740";// 短信模板
